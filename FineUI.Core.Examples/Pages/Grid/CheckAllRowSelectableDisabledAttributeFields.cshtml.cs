...
{
    public partial class CheckAllRowSelectableDisabledAttributeFieldsModel : BaseModel
    {
        ...
        protected void Grid1_RowDataBound(object sender, GridRowDataBoundEventArgs e)
        {
            ...
            {
                e.SetFieldValue("ResolvedRowSelectable", false);
            }
            else
            {
                e.SetFieldValue("ResolvedRowSelectable", true);
            }
        }
