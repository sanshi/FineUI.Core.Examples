...
{
    public partial class GroupFieldSortModel : BaseModel
    {
        ...
        private void LoadData()
        {
            ...
            Grid1.SortField = sortField;
            Grid1.SortDirection = sortDirection;

            Grid1.DataSource = GetSortedDataTable(sortField, sortDirection);
            Grid1.DataBind();
        }
