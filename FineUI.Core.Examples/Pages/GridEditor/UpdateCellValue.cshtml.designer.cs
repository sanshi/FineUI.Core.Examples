...
{
	public partial class UpdateCellValueModel
	{
		...
		protected FineUI.Core.NumberBox nbChineseScore;
		protected FineUI.Core.NumberBox nbMathScore;
		protected FineUI.Core.NumberBox nbTotalScore;
