...
{
    public partial class PagingSummaryDataLockColumnModel : BaseModel
    {
        ...
        private void LoadData()
        {
            ...
            // 2.获取当前分页数据
            var pagedData = GetPagedDataTable(pageIndex: Grid1.PageIndex, pageSize: Grid1.PageSize);
            Grid1.DataSource = pagedData;
            Grid1.DataBind();

            // 3. 合计行数据
            Grid1.SummaryData = GetSummaryData(pagedData);
        }
